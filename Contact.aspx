<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="ElectricShop.Contact" %>

<!DOCTYPE html>
<html lang="en">
<head>
	<title> محلات فواز عزايزة للادوات الكهربائية - ابقى على تواصل</title>
	<meta charset="UTF-8">
			...
			<div class="row">
				...
				<div class="col-md-6 p-b-30" >
					<form class="leave-comment">
						<h4 class="m-text26 p-b-36 p-t-15" lang="arabic"dir="rtl">
							أرسل لنا رسالتك
						</h4>

						<div class="bo4 of-hidden size15 m-b-20" lang="arabic"dir="rtl">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="name" placeholder="الاسم الكامل">
						</div>

						<div class="bo4 of-hidden size15 m-b-20" lang="arabic"dir="rtl">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="phone-number" placeholder="رقم الهاتف">
						</div>

						<div class="bo4 of-hidden size15 m-b-20" lang="arabic"dir="rtl">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="email" placeholder="البريد الالكتروني">
						</div>

						<textarea class="dis-block s-text7 size20 bo4 p-l-22 p-r-22 p-t-13 m-b-20" name="message" placeholder="ادخل رسالتك هنا" lang="arabic"dir="rtl"></textarea>
